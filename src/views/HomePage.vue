<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      <div id="container">
        <div>
          <ion-button color="secondary" @click="getSomethings"
            >TEST AXIOS</ion-button
          >
        </div>
        <div>
          <ion-button color="secondary" @click="changeLanguage"
            >CHANGE LANG</ion-button
          >
        </div>
        ...
        <div
          class="icon iconfont icon-lingdang"
